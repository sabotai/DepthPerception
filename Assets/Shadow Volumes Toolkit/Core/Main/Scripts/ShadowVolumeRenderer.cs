...
public class ShadowVolumeRenderer : MonoBehaviour
{
	...
	private void SetMaterials()
	{
		...
		{
			GetComponent<Renderer>().sharedMaterials = new Material[] { screenClear, screenFinal };
		}
		else if (mode == ShadowCompatibilityMode.NoBlendOp)
		{
			GetComponent<Renderer>().sharedMaterials = new Material[] { screenClear, screenFlip0, screenFlip1, screenFlip2, screenFlip3, screenFinal };
		}
	}
